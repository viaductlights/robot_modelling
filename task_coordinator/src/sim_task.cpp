...
int main(int argc, char** argv)
{
  ...
  MoveGroupInterface bean_move_group(bean_node, "robot");
  MoveGroupInterface nemo_move_group(nemo_node, "robot");

  bean_move_group.setPlanningPipelineId("ompl");
  nemo_move_group.setPlanningPipelineId("ompl");

  auto plan_and_execute = [&logger](MoveGroupInterface& group, const geometry_msgs::msg::Pose& target,
  ...
  pose1.position.x = 2.2;
  pose1.position.y = -11.4;
  pose1.position.z = 0.0;
  pose1.orientation.x = 0.0;
  pose1.orientation.y = 0.0;
  pose1.orientation.z = -0.98;
  pose1.orientation.w = 0.17;
