...
def generate_launch_description():
    ...
    package_name = 'nemo1_description'
    ...
    bridge = Node(
        ...
        arguments=[
            ...
            '/world/empty/model/nemo1/joint_state@sensor_msgs/msg/JointState[gz.msgs.Model',
        ],
        remappings=[
            ('/world/empty/model/nemo1/joint_state', 'joint_states'),
        ],
        parameters=[{'use_sim_time':True}],
        output='screen'
    )
